...
Root: HKCU; Subkey: "SOFTWARE\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers"; ValueType: string;  ValueName: "{#MyAppInstallPath}\{#MyAppExeName}"; ValueData: "~ RUNASADMIN"
